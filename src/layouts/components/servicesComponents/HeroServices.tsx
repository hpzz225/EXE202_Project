import bg from "@/assets/dichvuimage.png";
      ...
      <div className="container mx-auto flex justify-between items-end px-[158px] ">
        <div className="w-[650px] mr-12">
          <h1 className=" text-[#35a5a7] text-[40px] font-baloo font-bold ">
            CÁC LOẠI DỊCH VỤ GIẶT
          </h1>
          <p className=" text-[#22566e] text-[20px] font-baloo font-400 mt-8  ">
            MOON hiểu nỗi lo về cái áo trắng tinh mới mua ko lâu bị lem màu,
            chiếc áo khoác len sợ bị xù lông hay bộ drap giường bị phai màu khi
            gửi giặt dịch vụ của khách hàng. Nhưng không sao cả, MOON luôn tận
            tay chăm sóc từng món đồ mà khách đã tin tưởng giao phó như chính
            quần áo của MOON vậy.
          </p>
        </div>
